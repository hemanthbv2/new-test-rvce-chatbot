...
modScript = modScript.replace(/let best = null;/, `let best = null; if(input === 'can you tell me about placements in mtech cse') { console.log('MATCHED:', JSON.stringify(matchedIntents, null, 2)); }`);
eval(modScript);

global.classifyIntent("can you tell me about placements in mtech cse");
